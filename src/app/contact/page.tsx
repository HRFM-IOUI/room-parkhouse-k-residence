  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch(
        "https://api-lq5th35eca-uc.a.run.app/send", // 新しいエンドポイントURL
        {
          method: "POST",
    ...
    <form onSubmit={handleSubmit} className="space-y-5">
      <div>
        ...
        <input
          ...
          className="w-full px-4 py-3 rounded-xl border border-[#e8dab2] bg-white text-gray-700 focus:outline-none focus:ring-2 focus:ring-[#bfa14a]"
        />
      </div>
