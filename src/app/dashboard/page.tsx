...
const ICONS = [
  ...
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 24 24" fill="white">
        ...
        <path d="M21 19l-5.3-6.2a1.3 1.3 0 0 0-2 0L8 17l-3-4-3 6h20z" />
      </svg>
    ),
  },
  {
  ...
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 24 24" fill="white">
        <path d="M2 12l5 5l5-5l5 5l5-5v10H2z" />
      </svg>
    ),
  },
];
...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      // 念のため最新トークンへ更新（claims/email取りこぼし防止）
      await user.getIdToken(true);
      // ★ ここで /api/allowed は呼ばない（404→signOut→リダイレクトの原因だった）
    })();
  }, [user, loading, router]);
